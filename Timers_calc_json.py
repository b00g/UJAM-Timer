...
col_0, col_1, col_2,col_3, col_4 = 20, 40, 166, 221, 363
...
class Timer:
	...
	def makeGUI(self, row, name, times):
		...
		self.reset_button.place(y=self.y, x=col_4-15, height=22)

		self.del_button = tk.Button(self.parent, text="del", font=14, command=self.delete, bg='#690a1c', fg=text_color, bd=0)
		self.del_button.place(y=self.y, x=col_4+10, height=22)
		# canvas.update()
